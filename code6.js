...
gdjs.SubmitScreenCode.asyncCallback12042244 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.SubmitScreenCode.asyncCallback12042244(runtimeScene, asyncObjectsList)));
}
}
