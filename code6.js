...
gdjs.SubmitScreenCode.asyncCallback12808716 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.SubmitScreenCode.asyncCallback12808716(runtimeScene, asyncObjectsList)));
}
}
