...
gdjs.EndScreenCode.asyncCallback12843980 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.EndScreenCode.asyncCallback12843980(runtimeScene, asyncObjectsList)));
}
}
...
gdjs.EndScreenCode.userFunc0xcd1788 = function GDJSInlineCode(runtimeScene) {
"use strict";
...
gdjs.EndScreenCode.userFunc0xcd1788(runtimeScene);
