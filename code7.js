...
gdjs.EndScreenCode.asyncCallback11968564 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.EndScreenCode.asyncCallback11968564(runtimeScene, asyncObjectsList)));
}
}
...
gdjs.EndScreenCode.userFunc0xa6ecb8 = function GDJSInlineCode(runtimeScene) {
"use strict";
...
gdjs.EndScreenCode.userFunc0xa6ecb8(runtimeScene);
