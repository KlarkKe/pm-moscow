...
gdjs.EndScreenCode.asyncCallback13953908 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.EndScreenCode.asyncCallback13953908(runtimeScene, asyncObjectsList)));
}
}
...
gdjs.EndScreenCode.userFunc0x114c6c8 = function GDJSInlineCode(runtimeScene) {
"use strict";
...
gdjs.EndScreenCode.userFunc0x114c6c8(runtimeScene);
